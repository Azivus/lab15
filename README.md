...
int main(int argc, char *argv[])
{
	...
	while (finish_program != 0) {
		...
		if (n_operation == SEARCH_STUDENTS) {
			...
			printf("\nВведіть рік, вступу який вас цікавить:");
			scanf("%d", &enroll_year);
...
START_TEST(test_check_n_students)
{
	...
	char input_file2[] = "test/check_n_students/check_n_students2"; // 0
...
START_TEST(test_sorts_4_students_alphabet)
{
	...
	char expcted_sequence[][55] = {"Кацуба М.І.","Кравченко А.В.","Мосійчук А.Д.","Новіцький В.С."}; 
